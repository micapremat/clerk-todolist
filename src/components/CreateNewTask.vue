            ...
            <template v-slot:body>
                <div class=" w-[350px]">
                    ...
                    <div class="mt-6 text-left w-[350px]">
                        ...
                        <select class=" py-1 px-0 w-full text-sm text-black border-0 border-b-2 border-primary focus:outline-none focus:ring-0 focus:border-primary mt-1">
                    ...
                    <div class="mt-6 text-left w-[350px]">
                        ...
                        <textarea type="text" class="text-left text-black rounded-lg border border-primary border-3 py-2 mt-1 w-[350px] h-[200px] px-2" >
                            </textarea>
                    </div>
                </div>
